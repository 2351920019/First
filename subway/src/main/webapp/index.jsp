    ...
    <table id="t1">
      <tr>
        <td colspan="2" width="30%" height="50px">
          <p id="p1">线路号:</p><br>
          <label>
            <input id="inp1" type="text" name="roles" placeholder="请输入线路号">
          </label><br>
            <a>
          <button>
            查询
    ...
    <table id="t3">
      <tr>
        <td colspan="2" width="30%" height="50px">
          <p id="p3">出发地:</p>
          <label>
            <input id="inp3" type="text" name="departure" placeholder="请输入起点名称">
          </label>
          <p id="p4">目的地:</p>
          <label>
            <input id="inp4" type="text" name="destination" placeholder="请输入终点名称">
          </label>
          <button>
            查询
          </button>
